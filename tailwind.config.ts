  ...
  theme: {
    extend: {
      colors: {
        ...
        site: {
          bg: "var(--site-bg)",
          "bg-alt": "var(--site-bg-alt)",
          panel: "var(--site-panel)",
          "panel-strong": "var(--site-panel-strong)",
          line: "var(--site-line)",
          "line-strong": "var(--site-line-strong)",
          text: "var(--site-text)",
          "text-strong": "var(--site-text-strong)",
          ...
          "surface-hover": "var(--site-surface-hover)",
          "surface-active": "var(--site-surface-active)",
        },
        stitch: {
          primary: "#0f62fe",
